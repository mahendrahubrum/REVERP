 ...
 *         Jan 23 2014
 */
public class SalesStockUpdateUI extends SparkLogic {
	...
	public SPanel getGUI() {
		...
		try {
			...
			customerComboField = new SComboField(getPropertyName("customer"), 200, null,
			...
			generateButton = new SButton(getPropertyName("update"));
			...
			generateButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					...
					try {
						...
						Set<Long> salesIds = daoObj
								.getIssueHappenedSalesIDs(custId, CommonUtil
						...
						if (salesIds!=null&&salesIds.size()>0) {
							for (Long salesId : salesIds) {
								daoObj.programeticalUpdate(salesId);
							}
