 ...
 * property is <code>SCollectionContainer.ITEM_PROPERTY_ID</code>.
 * 
 ...
 * SCollectionContainer does not allow addition or removal of container
 * properties.
 * 
 */

public class SCollectionContainer implements Container, Container.Ordered,
        Container.Sortable {
    ...
    /**
     * Create new SCollectionContainer of simple types or JavaBeans. Properties
     ...
     */
    public SCollectionContainer(Collection<?> collection,
    ...
    /**
     * Create new SCollectionContainer of two dimensional array of primitive
     ...
     */
    public SCollectionContainer(List<Object[]> list, int idIndex) {
    ...
    /**
     * See {@link #SCollectionContainer(Collection, boolean, int)}
     * 
     * @param items
     * @param createBeanItems
     * @param itemIdMode
     */
    public SCollectionContainer(Object[] items, boolean createBeanItems,
            int itemIdMode) {
        this(Arrays.asList(items), createBeanItems, itemIdMode);
    }

    /**
     * Create new SCollectionContainer of JavaBeans and use property as id. This
     ...
     */
    public SCollectionContainer(Collection<?> collectionOfBeans,
            Object idPropertyId) {
    ...
    /**
     * See {@link #SCollectionContainer(Collection, Object)}.
     * 
     * @param arrayOfBeans
     * @param idPropertyId
     */
    
    public SCollectionContainer(Object[] arrayOfBeans, Object idPropertyId) {
        this(Arrays.asList(arrayOfBeans), idPropertyId);
    }

    /**
     * Create new SCollectionContainer of simple types. This is useful for
    ...
    public static SCollectionContainer fromPrimitives(Object[] primitives) {
    ...
    public static SCollectionContainer fromPrimitives(Collection<?> primitives,
            boolean indexed) {
        return new SCollectionContainer(primitives, false,
                indexed ? ITEM_ID_MODE_INDEX : ITEM_ID_MODE_OBJECT);
    }

    public static SCollectionContainer fromPrimitives(List<Object[]> primitives,
            int idIndex) {
        return new SCollectionContainer(primitives, idIndex);
    }
    
    
    public static SCollectionContainer fromBeans(Object[] beans) {
        return fromBeans(Arrays.asList(beans), false);
    }

    public static SCollectionContainer fromBeans(Object[] beans, boolean indexed) {
        return fromBeans(Arrays.asList(beans), indexed);
    }

    public static SCollectionContainer fromBeans(Object[] beans,
            Object idProperty) {
        return setList(Arrays.asList(beans), idProperty);
    }
    ...
    public static SCollectionContainer fromBeans(Collection<?> beans,
            boolean indexed) {
        return new SCollectionContainer(beans, true,
                indexed ? ITEM_ID_MODE_INDEX : ITEM_ID_MODE_OBJECT);
    }
    
 // Jinshad Changed the method to setList ( From fromBeans)
    public static SCollectionContainer setList(Collection<?> beans,
            Object idProperty) {
        return new SCollectionContainer(beans, idProperty);
    }
    ...
    public Item addItem(Object object) throws UnsupportedOperationException {
        throw new UnsupportedOperationException(
                "Cannot add items SCollectionContainer. Update the underlying collection instead.");
    }
    ...
    public boolean addContainerProperty(Object arg0, Class<?> arg1, Object arg2)
        ...
        throw new UnsupportedOperationException(
                "Cannot add container properties to SCollectionContainer.");
    }
    ...
    public boolean removeContainerProperty(Object arg0)
            throws UnsupportedOperationException {
        throw new UnsupportedOperationException(
                "Cannot remove container properties from SCollectionContainer.");
    }
