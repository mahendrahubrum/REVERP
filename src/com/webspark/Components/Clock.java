 ...
 *         Aug 21, 2013
 */
public class Clock extends SFormLayout {

	private static final long serialVersionUID = 520197650625509074L;

	public Clock(int width, int height) {

		setWidth(width + "px");
		setHeight(height + "px");
		setStyleName("clock_transparent");
		...
		cssLayout.setWidth("0px");
		cssLayout.setHeight("0px");
		ProgressIndicator indeIndicator = new ProgressIndicator();
		cssLayout.addComponent(indeIndicator);
