...
import com.webspark.dao.IDGeneratorDao;
	...
	public abstract class SContainerLayout extends SVerticalLayout{
		...
		public abstract void getChart(java.util.Date fromDate,java.util.Date toDate);
