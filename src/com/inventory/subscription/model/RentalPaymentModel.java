...
@Entity
@Table(name = SConstants.tb_names.I_RENTAL_PAYMENT)
public class RentalPaymentModel implements Serializable {

	public RentalPaymentModel() {
		super();
	}

	public RentalPaymentModel(long id, String description) {
		super();
		this.id = id;
	...
	// Added by Jinshad
	@Column(name = "sales_ids", length = 700)
