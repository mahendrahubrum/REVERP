...
@Entity
@Table(name = SConstants.tb_names.I_TAILORING_SALES_INVENTORY_DETAILS)
public class TailoringSalesInventoryDetailsModel implements Serializable {

	private static final long serialVersionUID = 5186123503497233222L;
	...
	@Column(name = "spec_field_ids", length = 1000)
	private String spec_field_ids;
	...
	public String getSpec_field_ids() {
		return spec_field_ids;
	}

	public void setSpec_field_ids(String spec_field_ids) {
		this.spec_field_ids = spec_field_ids;
	}
