 ...
 *         Aug 20, 2014
 */
public class PurchaseChartUI extends SContainerLayout {
	...
	protected DataSeries getSalesDetails(Date fromDate, Date toDate) {
		...
		try {
			list.addAll(dao.getPurchaseChartDetails(CommonUtil.getSQLDateFromUtilDate(fromDate),CommonUtil.getSQLDateFromUtilDate(toDate),getOfficeID()));
