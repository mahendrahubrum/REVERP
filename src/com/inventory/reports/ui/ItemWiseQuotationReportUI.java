 ...
 * @Project REVERP
 */
public class ItemWiseQuotationReportUI extends SparkLogic {
...
//	private long customerId;
	...
	private QuotationDao salesQuotationDao;
	...
	public SPanel getGUI() {
		...
		allColumns = new Object[] { TBC_SN, TBC_ID, TBC_DATE,TBC_CUSTOMER,TBC_ITEM, TBC_QUANTITY,  TBC_TOTAL };
		visibleColumns = new Object[]  { TBC_SN, TBC_DATE, TBC_CUSTOMER,TBC_ITEM,TBC_QUANTITY,  TBC_TOTAL };
		...
		itemDao = new ItemDao();
		salesQuotationDao = new QuotationDao();
			...
			officeComboField.addValueChangeListener(new ValueChangeListener() {
				...
				public void valueChange(ValueChangeEvent event) {
					try {
						...
						List<Object> customerList = ledgerDao
...
//							String items = "";
							...
							reportList = itemWiseReportDao.getItemwiseQuotationDetails(officeId, 
				...
				public void handleAction(Action action, Object sender, Object target) {
					try{
						...
						if (table.getValue() != null) {
							...
							QuotationUI option=new QuotationUI();
							option.setCaption(getPropertyName("quotation"));
				...
				public void valueChange(ValueChangeEvent event) {
					try{
						if (table.getValue() != null) {
							...
							QuotationModel mdl=salesQuotationDao.getQuotationModel(id);
							SFormLayout form = new SFormLayout();
							form.addComponent(new SHTMLLabel(null,"<h2><u>"+getPropertyName("quotation")+"</u></h2>"));
							form.addComponent(new SLabel(getPropertyName("quotation_no"),mdl.getQuotation_no()+""));
						...
						/*	boolean noData = true;
							...
							if (customerComboField.getValue() != null
									&& !customerComboField.getValue()
											.equals("")) {
								customerId = toLong(customerComboField.getValue()
										.toString());
							}
							if (officeComboField.getValue() != null
							...
							if(reportList.size()>0){
								...
								report.setReportFileName("ItemWise Quotation Report");
								
								map.put("REPORT_TITLE_LABEL", getPropertyName("item_wise_quotation_report"));
								...
								map.put("SUPPLIER_OR_CUSTOMER_LABEL", getPropertyName("customer"));
