 ...
 * @Project REVERP
 */
public class ItemWisePurchaseGRNReportUI extends SparkLogic {
...
//	private long customerId;
	...
	private PurchaseGRNDao purchaseGRNDao;
...
//							String items = "";
							...
							reportList = itemWiseReportDao.getItemwisePurchaseGRNDetails(officeId, 
				...
				public void handleAction(Action action, Object sender, Object target) {
					try{
						...
						if (table.getValue() != null) {
							...
							PurchaseGRNUI option=new PurchaseGRNUI();
							option.setCaption(getPropertyName("purchase_grn"));
				...
				public void valueChange(ValueChangeEvent event) {
					try{
						if (table.getValue() != null) {
							...
							PurchaseGRNModel mdl=purchaseGRNDao.getPurchaseGRNModel(id);
							SFormLayout form = new SFormLayout();
							form.addComponent(new SHTMLLabel(null,"<h2><u>"+getPropertyName("purchase_grn")+"</u></h2>"));
							form.addComponent(new SLabel(getPropertyName("grn_no"),mdl.getGrn_no()+""));
					...
					try {
						...
						/*	boolean noData = true;
							...
							if(reportList.size()>0){
								...
								report.setReportFileName("ItemWise Purchase GRN Report");
								
								map.put("REPORT_TITLE_LABEL", getPropertyName("item_wise_purchase_grn_report"));
