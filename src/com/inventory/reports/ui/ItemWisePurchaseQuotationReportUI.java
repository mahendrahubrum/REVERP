 ...
 * @Project REVERP
 */
public class ItemWisePurchaseQuotationReportUI extends SparkLogic {
...
//	private long customerId;
	...
	private PurchaseQuotationDao purchaseQuotationDao;
	...
	public SPanel getGUI() {
		...
		itemDao = new ItemDao();
		purchaseQuotationDao = new PurchaseQuotationDao();
...
//							String items = "";
							...
							reportList = itemWiseReportDao.getItemwisePurchaseQuotationDetails(officeId, 
				...
				public void handleAction(Action action, Object sender, Object target) {
					try{
						...
						if (table.getValue() != null) {
							...
							PurchaseQuotationUI option=new PurchaseQuotationUI();
							option.setCaption(getPropertyName("purchase_quotation"));
				...
				public void valueChange(ValueChangeEvent event) {
					try{
						if (table.getValue() != null) {
							...
							PurchaseQuotationModel mdl=purchaseQuotationDao.getPurchaseQuotationModel(id);
							SFormLayout form = new SFormLayout();
							form.addComponent(new SHTMLLabel(null,"<h2><u>"+getPropertyName("purchase_quotation")+"</u></h2>"));
					...
					try {
						...
						/*	boolean noData = true;
							...
							if(reportList.size()>0){
								...
								report.setReportFileName("ItemWise Purchase Quotation Report");
								
								map.put("REPORT_TITLE_LABEL", getPropertyName("item_wise_purchase_quotation_report"));
