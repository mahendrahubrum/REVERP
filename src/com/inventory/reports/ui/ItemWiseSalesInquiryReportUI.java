 ...
 * @Project REVERP
 */
public class ItemWiseSalesInquiryReportUI extends SparkLogic {
...
//	private long customerId;
	...
	public SPanel getGUI() {
		...
		itemDao = new ItemDao();
		salesInquiryDao = new SalesInquiryDao();
...
//							String items = "";
							...
							reportList = itemWiseReportDao.getItemwiseSalesInquiryDetails(officeId, 
				...
				public void handleAction(Action action, Object sender, Object target) {
					try{
						...
						if (table.getValue() != null) {
							...
							SalesInquiryUI option=new SalesInquiryUI();
							option.setCaption(getPropertyName("sales_inquiry"));
				...
				public void valueChange(ValueChangeEvent event) {
					try{
						if (table.getValue() != null) {
							...
							SalesInquiryModel mdl=salesInquiryDao.getSalesInquiryModel(id);
							SFormLayout form = new SFormLayout();
							form.addComponent(new SHTMLLabel(null,"<h2><u>"+getPropertyName("sales_inquiry")+"</u></h2>"));
					...
					try {
						...
						/*	boolean noData = true;
							...
							if(reportList.size()>0){
								...
								report.setReportFileName("ItemWise Sales Inquiry Report");
								
								map.put("REPORT_TITLE_LABEL", getPropertyName("item_wise_sales_inquiry_report"));
