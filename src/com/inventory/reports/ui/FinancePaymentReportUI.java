...
import com.inventory.finance.ui.FinancePaymentUI;
 ...
 *         Jan 30, 2014
 */
public class FinancePaymentReportUI extends SparkLogic {

	private static final long serialVersionUID = -369431990357617019L;
	...
	static String TBC_TO = "To Account";
	...
	public SPanel getGUI() {
		...
		allColumns = new Object[] { TBC_SN, TBC_ID,TBC_DATE,TBC_FROM, TBC_TO,TBC_AMOUNT,TBC_DESC};
		visibleColumns = new Object[] { TBC_SN,TBC_DATE,TBC_FROM, TBC_TO,TBC_AMOUNT};
		...
		table.addContainerProperty(TBC_DESC, String.class, null,TBC_DESC, null, Align.LEFT);
		...
		officeComboField = new SOfficeComboField("", 100);
		...
		try {
			...
			accountField = new SComboField(getPropertyName("account"), 200,
					lst, "id", "name");
			accountField.setInputPrompt(getPropertyName("all"));
				...
				public void handleAction(Action action, Object sender, Object target) {
					try{
						...
						if (table.getValue() != null) {
							...
							FinancePaymentUI option=new FinancePaymentUI();
							option.setCaption(getPropertyName("sales"));
							option.getJournalNumberList().setValue((Long) item.getItemProperty(TBC_ID).getValue());
							option.center();
				...
				public void valueChange(ValueChangeEvent event) {
					try{
						if (table.getValue() != null) {
							...
							form.addComponent(new SHTMLLabel(null,"<h2><u>"+getPropertyName("finance_payment")+"</u></h2>"));
			...
			showButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					...
					try {
						...
						reportList = dao.getFinTransactionReport(accid,
						...
						if(reportList.size()>0){
							...
							while(itr.hasNext()){
								...
								table.addItem(new Object[]{
										...
										bean.getFromaccount(),
										bean.getToaccount(),
										bean.getAmount(),bean.getDescription()},table.getItemIds().size()+1);
							}
						}
						else{
				...
				public void buttonClick(ClickEvent event) {
					...
					try {
						...
						if (reportList.size() > 0) {
							...
							report.setJrxmlFileName("FinancePaymentReport");
							report.setReportFileName("FinancePaymentReport");
							
							params.put("REPORT_TITLE_LABEL", getPropertyName("finance_payment_report"));
							...
							params.put("TO_ACCOUNT_LABEL", getPropertyName("to_account"));
