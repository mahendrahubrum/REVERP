 ...
 */
public class ItemWiseSalesOrderReportUI extends SparkLogic {
				...
				public void buttonClick(ClickEvent event) {
					...
					try {
						...
						if (officeComboField.getValue() != null) {
							...
							reportList = new SalesReportDao().getItemWiseSalesOrderDetails(
									itemID,
									custId,
									CommonUtil
							...
							if (reportList.size() > 0) {
								...
								report.setJrxmlFileName("ItemWiseSalesOrder_Report");
								report.setReportFileName("ItemWise Sales Order Report");
//								report.setReportTitle("ItemWise Sales Order Report");
								
								map.put("REPORT_TITLE_LABEL", getPropertyName("item_wise_sales_order_report"));
