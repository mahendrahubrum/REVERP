...
public class PurchasePeriodicalAnalysisReportUI extends SparkLogic {
	...
	private static final String TBC_PURCHASE = "Purchase";
	...
	//	subTable.setStyleName("table_wrap_style");
		...
		subTable.addContainerProperty(TBC_PURCHASE, String.class, null,
		...
		subTable.setColumnExpandRatio(TBC_PURCHASE, 2f);
				...
				if (isValid()) {
					try {
						List<PeriodicalAnalysisReportBean> list = periodicalAnalysisReportDao
								.getPurchasePeriodicalAnalysisReport(toLong(officeComboField.getValue()), 
					...
					/*	long prevId = 0;
						...
						*/
						if(list.size() == 0){
							...
							report.setReportFileName("Purchase Periodical Analysis Report");
							report.setReportTitle(getPropertyName("purchase_periodical_analysis_report"));
							...
							parameters.put("headTag", getPropertyName("purchase"));
