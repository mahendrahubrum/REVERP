 ...
 * @Project REVERP
 */
public class ItemWiseDeliveryNoteReportUI extends SparkLogic {
...
//							String items = "";
							...
							reportList = itemWiseReportDao.getItemwiseDeliveryNoteDetails(officeId, 
				...
				public void valueChange(ValueChangeEvent event) {
					try{
						if (table.getValue() != null) {
							...
							DeliveryNoteModel mdl=deliveryNoteDao.getDeliveryNoteModel(id);
							SFormLayout form = new SFormLayout();
							form.addComponent(new SHTMLLabel(null,"<h2><u>"+getPropertyName("delivery_note")+"</u></h2>"));
							form.addComponent(new SLabel(getPropertyName("delivery_note_no"),mdl.getDeliveryNo()+""));
					...
					try {
						...
						/*	boolean noData = true;
							...
							if(reportList.size()>0){
								...
								report.setReportFileName("ItemWise Delivery Note Report");
								
								map.put("REPORT_TITLE_LABEL", getPropertyName("item_wise_delivery_note_report"));
