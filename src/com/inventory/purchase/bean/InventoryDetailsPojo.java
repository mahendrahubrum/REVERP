...
public class InventoryDetailsPojo {
	...
	long id, order_id, item_id, unit_id, tax_id, inventry_details_id, stock_id,container_no;
	private long status;
	...
	public InventoryDetailsPojo(long order_id, long inventry_details_id,
	...
	public InventoryDetailsPojo(long order_id, long inventry_details_id,
			...
			double tax_percentage, double qunatity, double unit_price,
			double discount_amount, double balance,
			 Date manufacturing_date , Date expiry_date,long container_no) {
		super();
		this.order_id = order_id;
		this.inventry_details_id = inventry_details_id;
		this.item_id = item_id;
	...
	public InventoryDetailsPojo(long id, String stock_details) {
		super();
		this.id = id;
	...
	public InventoryDetailsPojo(long id, String stock_details, long status) {
		super();
		this.id = id;
		this.stock_details = stock_details;
		this.status=status;
	...
	public InventoryDetailsPojo(String ledger_name, double unit_price, Date date) {
		super();
