...
@Entity
@Table(name = SConstants.tb_names.I_MATERIAL_MAPPING_DETAILS)
public class MaterialMappingInventoryDetailsModel implements Serializable {

	
	private static final long serialVersionUID = -5050081950096464651L;

	public MaterialMappingInventoryDetailsModel() {
		this.description="";
	}
