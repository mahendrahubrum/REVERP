...
import com.inventory.tailoring.report.dao.TailoringCustomerLedgerReportDao;
import com.inventory.tailoring.ui.TailoringCustomerPaymentsUI;
 ...
 *         Dec 22, 2014
 */
public class TailoringCustomerLedgerReportUI extends SparkLogic {
	...
	private TailoringCustomerLedgerReportDao daoObj;
	...
	public SPanel getGUI() {
		...
		try {
			...
			ledgertSelect = new SComboField(getPropertyName("customer"), 200,
					...
					"id", "name");
			ledgertSelect.setInputPrompt("-------------Select-----------");
			...
			daoObj = new TailoringCustomerLedgerReportDao();
				...
				public void handleAction(final Action action,
					...
					if (table.getValue() != null) {
						...
						if (item.getItemProperty(TBC_TYPE).getValue()
								.equals("Sale")) {
							TailoringSalesUI purchase = new TailoringSalesUI();
							purchase.setCaption("Sales");
							purchase.loadSale((Long) item.getItemProperty(TBC_ID)
											.getValue());
							purchase.center();
							...
							purchase.addCloseListener(closeListener);
								...
								.equals("Receipt")) {
							TailoringCustomerPaymentsUI payment = new TailoringCustomerPaymentsUI();
					...
					try {
						...
						if (table.getValue() != null) {
							...
							if (itm.getItemProperty(TBC_TYPE).getValue()
								...
								TailoringSalesModel objModel = new TailoringSalesDao()
										.getSale(id);
								SFormLayout form = new SFormLayout();
								form.addComponent(new SHTMLLabel(null,
										"<h2><u>Sale</u></h2>"));
								form.addComponent(new SLabel("Sales No. :",
										objModel.getSales_number() + ""));
								form.addComponent(new SLabel("Ref No. :",
								...
								while (itmItr.hasNext()) {
									invObj = (TailoringSalesInventoryDetailsModel) itmItr
											.next();
...
//								}
								...
								form.addComponent(grid);
								form.addComponent(new SLabel("Comment :",
...
//							.getAddressString(ledger.getAddress().getId()));
					...
					report.setReportTitle("Customer Ledger");
					report.setReportSubTitle("From  : "
							+ CommonUtil.formatDateToCommonFormat(fromDate
									.getValue())
							+ "   To  : "
